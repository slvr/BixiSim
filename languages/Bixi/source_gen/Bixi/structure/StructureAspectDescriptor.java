...
public class StructureAspectDescriptor extends BaseStructureAspectDescriptor {
  ...
  public Collection<ConceptDescriptor> getDescriptors() {
    return Arrays.asList(myConceptBikeRack, myConceptMember, myConceptMemberMovement, myConceptMovement, myConceptNeighbourhood, myConceptRandomMovement, myConceptRedistribution, myConceptStreet);
  }
  ...
  private static ConceptDescriptor createDescriptorForBikeRack() {
    ...
    b.associate("streetH", 0x3663fa1ece76bbeaL).target(0x80abab196e2b414aL, 0xbf443232f0a94d40L, 0x32f20c5cdebdeafbL).optional(false).origin("3919251110962314218").done();
    b.associate("StreetV", 0x3663fa1ece76bbedL).target(0x80abab196e2b414aL, 0xbf443232f0a94d40L, 0x32f20c5cdebdeafbL).optional(false).origin("3919251110962314221").done();
    return b.create();
  }
  ...
  private static ConceptDescriptor createDescriptorForNeighbourhood() {
    ...
    b.version(2);
    b.aggregate("streets", 0x32f20c5cdebdeaf7L).target(0x80abab196e2b414aL, 0xbf443232f0a94d40L, 0x32f20c5cdebdeafbL).optional(true).ordered(true).multiple(true).origin("3671010239273888503").done();
    b.aggregate("racks", 0x3663fa1ece76bbd6L).target(0x80abab196e2b414aL, 0xbf443232f0a94d40L, 0x32f20c5cdebdfb51L).optional(true).ordered(true).multiple(true).origin("3919251110962314198").done();
    return b.create();
  }
  ...
  private static ConceptDescriptor createDescriptorForStreet() {
    ...
    b.version(2);
    b.prop("direction", 0x32f20c5cdebdeb0dL, "3671010239273888525");
